...
public class SignedJWT extends JWT {
	...
	/**
	 * Signs this JSON Web Token (JWT) with the specified HMAC shared
	...
	/**
	 * Signs this JSON Web Token (JWT) with the specified private RSA key.
	...
	/**
	 * Signs this JSON Web Token (JWT) with the specified elliptic curve

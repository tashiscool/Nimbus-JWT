 ...
 *
 * <ul>
 *     <li><a href="http://tools.ietf.org/html/draft-ietf-jose-json-web-key-02">JWK draft 02</a>.
 *     <li><a href="http://tools.ietf.org/html/draft-ietf-jose-json-web-algorithms-02">JWA draft 02</a>.
 * </ul>
 *
...
public abstract class JWK {
	 ...
	 *
	 * @return The use, {@code null} if not specified or if the key is
	 *         intended for signatures as well as for encryption.
	 */
	public Use getUse() {
	 ...
	 * match a specific key. This can be used, for instance, to choose 
	 * among a set of keys within the JWK during key rollover. The key ID 
	 * may also correspond to a JWS "kid" value.
	 *
	...
	/**
	 * Returns a JSON object representation of this JWK (only the common 
	 * members will be included). This method is intended to be called from 
	 * extending classes.
	 *
	 * <p>Example:
	 *
	 ...
	 * @return The JWK.
	 *
	 * @throws JWKException If the JSON object couldn't be parsed to a valid
	 *                      and supported JWK.
	 */

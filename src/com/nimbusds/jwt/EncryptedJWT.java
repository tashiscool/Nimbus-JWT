...
public class EncryptedJWT extends JWT {
	...
	/**
	 * Encrypts this JSON Web Token (JWT) with the specified public RSA key.
	 * The JWT must be in a {@link State#UNENCRYPTED unencrypted} state. The
	 * clear text will be compressed if the 
	 * {@link JWEHeader#getCompressionAlgorithm compression algorithm} is 
	 * set to {@link CompressionAlgorithm#DEF DEFLATE}.
	 *
	...
	/**
	 * Encrypts this JSON Web Token (JWT) with the specified secret AES key.
	 * The JWT must be in a {@link State#UNENCRYPTED unencrypted} state. The 
	 * clear text will be compressed if the 
	 * {@link JWEHeader#getCompressionAlgorithm compression algorithm} is 
	 * set to {@link CompressionAlgorithm#DEF DEFLATE}.
	 ...
	 * The JWT must be in a {@link State#ENCRYPTED encrypted} state. The 
	 ...
	 * is set to {@link CompressionAlgorithm#DEF DEFLATE}.
	 *
	 * <p>Supported algorithms:
	 *
	 * <ul>
	 ...
	 * period ('.') characters. It must be in a {@link State#ENCRYPTED 
	 ...
	 *                      {@link State#ENCRYPTED signed} or
	 *                      {@link State#DECRYPTED verified state}.
	 */

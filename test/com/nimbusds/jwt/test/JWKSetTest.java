...
public class JWKSetTest extends TestCase {
	...
	public void testParse() {
		...
		assertEquals(JWK.Use.ENCRYPTION, key.getUse());
	...
	public void testSerializeAndParse() {
		...
		assertEquals(JWK.Use.ENCRYPTION, ecKey.getUse());
		...
		assertEquals(JWK.Use.SIGNATURE, rsaKey.getUse());
